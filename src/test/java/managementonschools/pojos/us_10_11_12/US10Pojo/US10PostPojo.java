...
public class US10PostPojo implements Serializable {
	private String day;
	...
	public US10PostPojo(String day, int educationTermId, List<Integer> lessonIdList, String startTime, String stopTime) {
		this.day = day;
