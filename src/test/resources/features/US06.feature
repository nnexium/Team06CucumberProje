...
Feature: US06 Admin, Vice Dean hesabı olusturabilmelidir.
 ...
 Scenario: TC01_Admin_Vice_Dean_olusturabilmelidir
   ...
   Scenario: TC02_Dean_Vice_Dean_olusturabilmelidir_Negatif
      Given kullanici anasayfaya giderr
      When kullanici login butonuna tiklar
      And kullanici dean olarak giris yapar
      And kullanici 2 saniye bekler
   ...
   Scenario: TC03_Dean_Vice_Dean_olusturabilmelidir_Negatif
      Given kullanici anasayfaya giderr
      When kullanici login butonuna tiklar
      And kullanici dean olarak giris yapar
      And kullanici 2 saniye bekler
   ...
   Scenario: TC04_Dean_Vice_Dean_olusturabilmelidir_Negatif
      Given kullanici anasayfaya giderr
      When kullanici login butonuna tiklar
      And kullanici dean olarak giris yapar
      And kullanici 2 saniye bekler
